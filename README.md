...
<img src="https://pin.it/oQ7zYoH4N" width="100%" />
...
<p>
  <img src="https://komarev.com/ghpvc/?username=MannyG3&label=PROFILE+VIEWS&color=00ff9c&style=flat" />
</p>
...
<p>
  <code>while(alive) { code(); coffee(); debug(); repeat(); }</code>
</p>
...
[debugging] A bug that mysteriously disappears
            whenever I start screen sharing.
```
...
[✓] Coffee        : Required
[✓] Git           : Commit before thinking
[✓] Debugging     : 90% console.log()
[✓] StackOverflow : Emotionally supported
[!] Production    : "But it worked locally..."
[!] Sleep         : Dependency not installed
```
...
<code>open to collaboration • [mayurgund@yahoo.com](mailto:mayurgund@yahoo.com)</code>
